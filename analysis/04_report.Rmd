...
For the first time this year COMBINE ran a national survey of students. The goal 
of the was were to learn more about the Australian bioinformatics and
...
Here are some of the interesting results from the survey. When interpreting what
is shown here it is important to remember that this is a fairly small and
selective sample. As a result the data is more a reflection of the COMBINE
community than the wider student community, however we still believe this has
been a useful and informative exercise. We also believe that this is a valuable
opportunity to see what other student's experiences are like and contrast them
with their own.

Who completed the survey?
=========================

We initally received over 80 responses to the survey but after removing few that
were duplicated or incomplete we were left with `r nrow(responses)` responses.
The majority of there were from full-time PhD students, however there were some
other course types and a few part-time responses. The sample was also biased
towards female and domestic students.
...
coming into bioinformatics from biology, but male students were slightly more 
...
Overall we saw quite a spread of ratings for all skils. Female students were
...
(university and government) and part-time work were the biggests sources of
financial support but unsurprising this chances by factors such as courst type
or residency.
...
Domestic students are much more likely to be supported by goverment scholarships
or part-time work while international students typically rely on university
funding. Masters students rely more on part-time work and parental support but
worringly half also responded that they supported themselves using their
savings. We neglected to included government welfare as an option in the survey
but this was recored in other responses, along with scholarships from other
funding bodies.
...
coursework classes. The majority of these were Master by coursework students by
they covered all levels from Bachelor to PhD.
...
Coursework students are enrolled in one to four classes this semester with
between one and 30 hours of classes a week. There is considerable variety in how
classes are assessed with students having up to 16 assignments in a semester and
up to six exams. 

Students are completing a range of different kinds of classes, including
biological, computational and statistical classes. 
...
These are fairly evenly spread, although there are less interdisciplinary than
we expected. This may represent a truth about the fragmented nature of
universities or it could be related to how these questions were worded.
...
that their Masters course has "No support. No prerequisites." and was "Badly
designed" while others focused on assessment "Too many assignments. Interrupts
meaningful learning". Other students felt they were not being adaquately
...
This comments raise some considerable concerns and suggest that universities
...
`r nrow(responses)`). These project cover a range of research focuses. As we
...
Short read sequencing technologies including RNA-seq and whole geneome
sequencing were the most common sources of data. Other technologies not given
as ootions include ChIP-seq and ATAC-seq.
...
research (R, Shell, Pyton and Git), with 80 percent of students using R. Other
tools are used by some students by these are clearly the current dominant
programming tools.
...
While many students use the same sets of computaitonal tools there is 
...
Male students are international students were more likely to have purely
computational projects while female and domestic students showed a greater
spread. This may be related to background with female and domestic students
more likely to have a biology background and the related lab skills.
...
About twice as many male students students were collaborating with other groups 
at their university or institute while more female students collaborated with
other students. 
...
male supervisors is a result of the gender inbalance at higher levels of
academia rather than any preference from students.

We asked student to rate their supervisors on a range of qualities that can lead
to good student-supervisor relationships and success projects.
...
Female primary supervisor were rated more highly on most qualities, with the
...
computational backgrounds, for example one student said "...lack of expertise in
the field combined with lack of collaboration with other groups/researchers, and 
even not allowing me to consult other experts in the field..." and another
"Supervisor has no computational background so getting guidance on this area is 
challenging".
...
We also asked student more broadly about their sources of support outside their
...
students in their lives. These value are lower than we would hope to see and
...
complete a research. We are pleased to see that the majority of students are
provided with desks and computers as well as access to servers or high
performance computing that can be essential for many bioinformatics projects.
...
students hoping to continue in academia and needing opportunities to present
their work and meet people in the field. Most students had access to travel
grants with an application through their institute or university by those based
at research institutes had greater access to top up scholarships.
...
attend symposium". Access to prizes and awards, and travel bursaries were
perceived to be more beneficial my non-members than members. International
...
Statistical workshop are not something we have done in the past but are
...
buiding a student community but there is more we can do to make them more
attractive for more people. For example one comment suggested "...hold monthly 
bioinformatics meet up in each city and the program includes allocating desks/tags/etc for different topics (eg. DNA seq, RNA seq, etc.) for asking questions, networking, etc.".
...
"...a framework where students can connect with others for help and support with aspects of their project, e.g. questions on programming (language specific groups), troubleshooting advice, beta testers, etc.". Earlier this year we
opened up our Slack for any students to join and we hope it can become exactly
that kind of platform, as well as giving students more opportunity to get
involved with COMBINE.

To end with we love to receive comments like this which we think embodies
exactly what COMBINE is trying to achieve.
